...
SIZES = SUPPORTED_SHAPES["compute_pool"]
JSONL_PATH = Path(__file__).parent.parent / "results" / "timings" / "compute_pool.jsonl"
N_WARMUP = 5
N_ITERS = 10
...
def main() -> None:
    ...
    print("=" * 60)
    print("ComputePoolTemplate Characterization Sweep")
    print(f"Sizes: {SIZES}")
